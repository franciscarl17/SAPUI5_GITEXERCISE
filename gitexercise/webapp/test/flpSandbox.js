		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GIT Exercise",
									"targetURL": "#zbtpgitexercise-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpgitexercise-display": {
								"semanticObject": "zbtpgitexercise",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.gitexercise",
									"url": sap.ui.require.toUrl("zbtp/gitexercise")
								}
							}
						}
					}
